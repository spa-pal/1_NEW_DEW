...
public class Special_Settings {
    ...
    public Special_Settings() {
        ...
        /*
         * Итак, здесь мы добавим все нужные нам параметры, ой, системные установки, ну например их будет 3
         * Не забываем им прописать OIDы!!!
         */
        set.add(parameters[0]); // БПС
        set.add(parameters[1]); // Звук
        set.add(parameters[2]); // Звук
        set.add(parameters[3]); // Звук
        set.add(parameters[4]); // Звук
        set.add(parameters[5]); // Напряжение, необходимое для содержания батареи при 0 град окружающей среды
        set.add(parameters[6]); // Напряжение, необходимое для содержания батареи при 20 град окружающей среды
        set.add(parameters[7]); // Напряжение, необходимое для содержания батареи при 0 град окружающей среды
        set.add(parameters[8]); // Напряжение, необходимое для содержания батареи при 0 град окружающей среды
        set.add(parameters[9]); // Напряжение, необходимое для содержания батареи при 0 град окружающей среды
        set.add(parameters[10]); // Напряжение, необходимое для содержания батареи при 0 град окружающей среды
        set.add(parameters[11]); // Напряжение, необходимое для содержания батареи при 0 град окружающей среды
        set.add(parameters[12]); // Напряжение, необходимое для содержания батареи при 0 град окружающей среды
        set.add(parameters[13]); // Напряжение, необходимое для содержания батареи при 0 град окружающей среды
        set.add(parameters[14]); // Напряжение, необходимое для содержания батареи при 0 град окружающей среды
        set.add(parameters[15]); // Напряжение, необходимое для содержания батареи при 0 град окружающей среды
        set.add(parameters[16]); // Напряжение, необходимое для содержания батареи при 0 град окружающей среды
