...
public class UKU_Control_Panel_SNMP extends Abstract_spanel {
    ...
    private void jbInit() throws Exception {
        ...
        promo_label.setText("ООО \"13Системы промавтоматики\"");
    ...
    public void update_panel() {
        if (data.need_correct_interface_control.get() == 1){
            ...
            if (data.show_warning_table.get() == 1){
                JOptionPane.showMessageDialog(this, "Невозможно выполнить команду",
                                                         "Предупреждение",
                                          JOptionPane.WARNING_MESSAGE);
    ...
    public void enable_parallel_button_actionPerformed(ActionEvent e) {
        data.lifo.add((new Command_SNMP(Command_Handler.ENABLE_PARRALEL_OPERATION, 0)));
    }

    public void disable_parallel_button_actionPerformed(ActionEvent e) {
        data.lifo.add((new Command_SNMP(Command_Handler.DISABLE_PARRALEL_OPERATION, 0)));
    }
    ...
    public void compensation_charge_button_actionPerformed(ActionEvent e) {
        ...
        data.lifo.add((new Command_SNMP(Command_Handler.ENABLE_COMPENSATION_CHARGE, temp)));
    }
    ...
    public void disable_specfunctions_button_actionPerformed(ActionEvent e) {
        data.lifo.add((new Command_SNMP(Command_Handler.DISABLE_SPECIAL_FUNCTIONS, 0)));
    }
...
class UKU_Control_Panel_Big_unlock_psu_button_actionAdapter_SNMP implements
        ActionListener {
    private UKU_Control_Panel_SNMP adaptee;
    UKU_Control_Panel_Big_unlock_psu_button_actionAdapter_SNMP(UKU_Control_Panel_SNMP
            adaptee) {
        this.adaptee = adaptee;
    }
...
class UKU_Control_Panel_Big_set_bps_button_actionAdapter_SNMP implements
        ActionListener {
    private UKU_Control_Panel_SNMP adaptee;
    UKU_Control_Panel_Big_set_bps_button_actionAdapter_SNMP(UKU_Control_Panel_SNMP
            adaptee) {
        this.adaptee = adaptee;
    }
