...
#define DISPLAY_BAT_NUMBER				1
#define DISPLAY_BAT_VOLTAGE				2
#define DISPLAY_BAT_CURRENT				3
#define DISPLAY_BAT_TEMPERATURE			4
#define DISPLAY_BAT_CAPACITY				5
#define DISPLAY_BAT_CHARGE				6
#define DISPLAY_BAT_STATUS				7
