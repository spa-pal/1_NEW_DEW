...
public class SampleAgent implements VariableProvider {
    ...
    private Integer32 integer89 = new Integer32(67);
...
//        }
        ...
        InputStream configInputStream =
                SampleAgent.class.getResourceAsStream("/example/SampleAgentConfig.properties");
        ...
        InputStream tableSizeLimitsInputStream =
                SampleAgent.class.getResourceAsStream("/example/SampleAgentTableSizeLimits.properties");
    ...
    protected void registerMIBs() {
        ...
        try {
            SimData.registerSimData(server);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            final SampleAgent sampleAgent = new SampleAgent(commandLineParameters);
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    while (true){
                        sampleAgent.setInteger89(System.currentTimeMillis());
                        try {
                            Thread.sleep(200);
    ...
    private void setInteger89(long timeMillis) {
        integer89.setValue((int) timeMillis);
    }
